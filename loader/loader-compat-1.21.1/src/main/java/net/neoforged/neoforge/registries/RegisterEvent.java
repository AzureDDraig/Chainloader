...
public class RegisterEvent extends net.neoforged.bus.api.Event {
    ...
    private static <T> Registry<T> getRegistry(ResourceKey<? extends Registry<T>> registryKey) {
        ...
        try {
            ...
            System.err.println("[ChainLoader] NeoForge RegisterEvent: Error resolving registry for " + registryKey + ": " + t.getMessage());
        }
        return null;
    }
    ...
    public <T> void register(ResourceKey<? extends Registry<T>> registryKey, Consumer<RegisterHelper<T>> consumer) {
        ...
        if (registry == null) {
            System.err.println("[ChainLoader] NeoForge RegisterEvent: Could not find registry for key: " + registryKey);
            return;
        }
        ...
        RegisterHelper<T> helper = new RegisterHelper<T>() {
            ...
            public void register(ResourceLocation name, T value) {
                ...
                System.out.println("[ChainLoader] NeoForge RegisterEvent: Registered " + name + " to registry " + registry.key().location());
            }
        };
        ...
        try {
            ...
            System.err.println("[ChainLoader] NeoForge RegisterEvent: Failed during registration for registry " + registryKey + ":");
            t.printStackTrace();
        }
    }
}
